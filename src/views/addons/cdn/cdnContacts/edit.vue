<template>
  <div>
    <n-modal
      ...
      :title="formValue.id > 0 ? '编辑联系人 #' + formValue.id : '添加联系人'"
      :style="{
        width: dialogWidth,
      }"
    >
            ...
            <n-grid cols="1 s:1 m:1 l:1 xl:1 2xl:1" responsive="screen">
              ...
              <n-gi span="1">
                <n-form-item label="部门" path="department">
                  <n-input placeholder="请输入部门" v-model:value="formValue.department" />
                </n-form-item>
              </n-gi>
              <n-gi span="1">
                <n-form-item label="职务" path="duties">
                  <n-input placeholder="请输入职务" v-model:value="formValue.duties" />
                </n-form-item>
              </n-gi>
              <n-gi span="1">
...
<script lang="ts" setup>
  ...
  import { Edit, View } from '@/api/addons/cdn/cdnContacts';
