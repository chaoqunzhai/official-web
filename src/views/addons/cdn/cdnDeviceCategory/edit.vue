<template>
  <div>
    <n-modal
      ...
      :title="formValue.id > 0 ? '编辑分类 #' + formValue.id : '添加分类'"
      :style="{
        width: dialogWidth,
      }"
    >
        ...
        <n-spin :show="loading" description="请稍候...">
          ...
          >
            <n-grid cols="1 s:1 m:1 l:1 xl:1 2xl:1" responsive="screen">
              <n-gi span="1">
                <n-form-item label="父类型" path="pid">
                  <n-tree-select
                :options="treeOption"
              ...
              <n-gi span="1">
                <n-form-item label="编号" path="code">
                  <n-input placeholder="请输入编号" v-model:value="formValue.code" />
                </n-form-item>
              </n-gi>
              <n-gi span="1">
...
<script lang="ts" setup>
  ...
  import { Edit, View, MaxSort } from '@/api/addons/cdn/cdnDeviceCategory';
